...
| Token de update guardado em claro | `settings.json` na appdata. É a escolha deliberada face a compilá-lo no binário, mas quem lê o ficheiro lê o token. Um PAT fine-grained, só de leitura e só deste repositório, limita o estrago | #79 |
