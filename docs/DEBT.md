...
| #73/2 Revisão do Director visível | **Feito** — as linhas da revisão correm no mesmo transcript do run, o veredicto fica legível no cartão mesmo depois de Done, e o notice só sai com a revisão genuinamente a correr | #73 |
